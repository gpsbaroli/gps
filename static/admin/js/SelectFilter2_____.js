...
(function($) {
    ...
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            var filter_p_2 = quickElement('div', selector_div, '', 'id', 'search_by_custom_filter');
            ...
            var filter_input_2 = quickElement('input', filter_p_2, '', 'class','vDateField', 'type', 'text', 'placeholder', gettext("Search By Name"));
            filter_input_2.id = 'search_by_custom_input';
    ...
    window.addEventListener('load', function(e) {
        $('select.selectfilter, select.selectfilterstacked').each(function() {
		 ...
		 $('#search_by_submit').on('click',function(){
            var search_by_date = $('#search_by_custom_input').val();
			//alert($('#search_by_custom_input').length);
